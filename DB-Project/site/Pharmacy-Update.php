	<?php	
		...
		#define vars
		$pkargs = array($_GET['PharmacyId']);
		$args = array($_GET['Name'],$_GET['Town'],$_GET['StreetName'],$_GET['StreetNumber'],$_GET['PostalCode'],$_GET['PhoneNumber']);
		$pkfields = array('`PharmacyId`');
		$fields = array('Name','Town','StreetName','StreetNumber','PostalCode','PhoneNumber');
		$table = '`pharmacy`';
		$redirect = array('index.html','Pharmacy-Update.html');
