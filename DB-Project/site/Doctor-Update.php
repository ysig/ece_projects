	<?php	
		...
		#define vars
		$pkargs = array($_GET['DoctorId']);
		$args = array($_GET['FirstName'],$_GET['LastName'],$_GET['Speciality'],$_GET['ExperienceYears']);
		$pkfields = array('`DoctorId`');
		$fields = array('`FirstName`','`LastName`','`Speciality`','`ExperienceYears`');
		$redirect = array('index.html','Doctor-Update.html');
		$table = '`doctor`';
